export const CONFIRM_MESSAGES = {
  ...
  deleteAllPosts: () =>
    'Xóa TẤT CẢ bài viết (trừ bài đang có lịch đăng và bài đã đăng)? Admin xóa toàn bộ hệ thống; ContentManager chỉ xóa bài của mình. Hành động này không thể hoàn tác.',
